...
export default function Project({
  ...
  return (
    ...
    >
      <section className=" bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem]  even:pl-8 hover:bg-gray-200 transition rounded-2xl sm:group-even:pl-8 dark:bg-white/10 dark:hover:bg-white/20 dark:text-white">
        ...
        <Image
          ...
          quality={95}
          className="absolute hidden sm:block top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-xl 
        transition 
